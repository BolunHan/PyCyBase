...
# mappingproxy (CONFIG_VIEW) so that downstream code and diagnostics
# can inspect the build configuration at runtime.
...
CONFIG_VIEW = MappingProxyType(_config_view)
